...
public class EncodeUtils {
     ...
     * @return
     */
    public static String sha1(String text, String charset){
        MessageDigest msgDigest = null;
...
//        System.out.println(sha1("adfasdf", "utf-8"));
//        System.out.println(hmacsha1("adfasdf", "utf-8"));
//        System.out.println(SHA256("adfasdf", "utf-8"));

        System.out.println(MD5("123456", "utf-8"));
        String params = "id=1sdfwe12&name=adf";
        System.out.println(urlEncode(params));
        System.out.println(urlEncode(urlEncode(params)));


//        System.out.println(DigestUtils.md5Hex(String.valueOf(1292339720) + "e665045f057b262b94f678b58a909bbf"));
    }
}
